        ...
        <div className="bg-white py-8 px-4 shadow-xl shadow-blue-900/5 sm:rounded-3xl sm:px-10 border border-gray-100">
          ...
          {isRegistering && (
            <div className="mb-8 text-center">
              ...
              <p className="text-sm text-gray-500 mt-2">Preencha os dados abaixo para começar</p>
            </div>
          )}
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full border-gray-300 rounded-xl shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-3 border bg-gray-50"
